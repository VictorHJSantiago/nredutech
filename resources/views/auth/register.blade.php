  ...
  <form method="POST" action="{{ route('register') }}" class="register-form">
    ...
    <div class="form-grid">
      <div class="form-group">
        ...
        <input type="text" id="name" name="name" placeholder="Digite seu nome completo" value="{{ old('name') }}" required autofocus />
      </div>
      ...
      <div class="form-group">
        ...
        <div class="password-wrapper">
          <input type="password" id="password" name="password" placeholder="Crie uma senha (mín. 16 caracteres)" required />
